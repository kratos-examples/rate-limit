...
const file_article_article_proto_rawDesc = "" +
	...
	"\fListArticles\x12\x1c.article.ListArticlesRequest\x1a\x1a.article.ListArticlesReply\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/articlesB!Z\x1fdemo2kratos/api/article;articleb\x06proto3"
...
var file_article_article_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_article_article_proto_goTypes = []any{
	...
	(*ListArticlesReply)(nil),    // 10: article.ListArticlesReply
}
var file_article_article_proto_depIdxs = []int32{
	...
	2,  // 9: article.ArticleService.CreateArticle:output_type -> article.CreateArticleReply
	4,  // 10: article.ArticleService.UpdateArticle:output_type -> article.UpdateArticleReply
	6,  // 11: article.ArticleService.DeleteArticle:output_type -> article.DeleteArticleReply
	8,  // 12: article.ArticleService.GetArticle:output_type -> article.GetArticleReply
	10, // 13: article.ArticleService.ListArticles:output_type -> article.ListArticlesReply
