...
require (
	github.com/yylego/kratos-compare v0.0.1
...
replace (
	github.com/yylego/kratos-examples/demo1kratos => ./demo1kratos
	github.com/yylego/kratos-examples/demo2kratos => ./demo2kratos
)
